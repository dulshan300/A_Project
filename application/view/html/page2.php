...
<head>
    ...
    <link rel="shortcut icon" href="{{res_path}}ico/favicon.png">
    <title>Welcome - {{name}} Sample</title>
...
<div class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{url_home}}"> {{name}} </a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#">Home</a></li>
                <li><a href="{{url_site}}">About</a></li>
...
<div class="container">
    ...
    <footer>
        <p><u>{{name}}</u> &copy; CDL 2013 - {{this_year}}</p>
    </footer>
</div>
<!-- /container -->
